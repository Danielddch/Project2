...
usdimg = loadImage("USD.png");
eurimg = loadImage("EUR.png");
gbpimg = loadImage("GBP.png");
cadimg = loadImage("CAD.png");
}
...
function setup() {
  ...
  mov3 = windowWidth / 4 + random(-100, 100);
  mov4 = windowHeight / 4 + random(-100, 700);
  mov5 = windowWidth / 4 + random(-100, 100);
  mov6 = windowHeight / 4 + random(-100, 700);
...
function maincircle() {
  ...
  imageMode(CENTER);
  //earth.resize(0,100);
  image(earth, width/2, height/2, 100, 100)
...
function extracircles() {
  ...
  usdimg.resize(moni.rates.USD * 200,moni.rates.USD * 150);
  image(usdimg,mov1,mov2);
  eurimg.resize(moni.rates.EUR *100,moni.rates.EUR *100);
  image(eurimg,mov3,mov4);
  gbpimg.resize(moni.rates.GBP * 200,moni.rates.GBP * 200);
  image(gbpimg,mov5,mov6);
  cadimg.resize(moni.rates.CAD * 100,moni.rates.CAD * 100)
  image(cadimg,mov9,mov10);
  fill(40, 120, 10);
